...
import { LayoutDashboard, Users, Building, LogOut, Bell, IndianRupee, Bluetooth, PieChart } from "lucide-react";
      ...
      <div className="flex-1 flex flex-col overflow-hidden w-full print:overflow-visible">
        ...
        <header className="print:hidden h-16 bg-[var(--card)] border-b border-[var(--border)] flex items-center justify-between px-4 sm:px-8 z-10 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/owner/profile" className="flex items-center gap-3 pl-4 border-l border-[var(--border)] hover:opacity-80 transition-opacity">
              <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-green-500 to-teal-500 flex items-center justify-center text-white font-bold text-sm shadow-md">
                {userName.charAt(0)}
              </div>
